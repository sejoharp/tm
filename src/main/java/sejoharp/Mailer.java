...
public class Mailer {
	...
	public MimeMessage createMessage(Match match, Player player) throws MessagingException {
	...
	public String formatSubject(Match match) {
		return String.format("Tisch:%s | Disziplin:%s | Runde:%s | %s vs. %s",
				match.getTableNumber(), match.getDisciplin(), match.getRound(),
